...
import com.john_g_shultz.site.domain.util.CustomLocalDateSerializer;
 ...
 */
@Entity
@Table(name = "T_FUN_HOUSE")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Fun_house implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Fun_house fun_house = (Fun_house) o;
